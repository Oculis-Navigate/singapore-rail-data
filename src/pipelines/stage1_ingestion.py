...
class Stage1Ingestion(PipelineStage):
    ...
    def _match_stations(self, groups: Dict[str, List[Dict]]) -> List[Stage1Station]:
        ...
        for station_data in consolidated_output:
            ...
            stage1_station = Stage1Station(
                ...
                exits=exits,
                fandom_url=self._build_fandom_url(official_name, mrt_codes),
    ...
    def _apply_corrections(self, stations: List[Stage1Station]) -> List[Stage1Station]:
        ...
        for station in stations:
            station.fandom_url = self._build_fandom_url(station.official_name, station.mrt_codes)
        
        logger.info("Applied LRT hub codes and naming corrections")
        return stations
    
    def _build_fandom_url(self, station_name: str, mrt_codes: Optional[List[str]] = None) -> str:
        """
        ...
        # Note: "MRT/LRT STATION" pattern is handled by interchange logic above
        ...
        # Add suffix based on station type
